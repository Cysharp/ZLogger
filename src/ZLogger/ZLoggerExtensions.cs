...
namespace ZLogger
{
    public static partial class ZLoggerExtensions
    {
        ...
        {
            ZLog(logger, LogLevel.Trace, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
        ...
        {
            ZLog(logger, LogLevel.Debug, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
        ...
        {
            ZLog(logger, LogLevel.Information, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
        ...
        {
            ZLog(logger, LogLevel.Warning, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
        ...
        {
            ZLog(logger, LogLevel.Error, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
        ...
        {
            ZLog(logger, LogLevel.Critical, eventId, exception, ref message.InnerHandler, memberName, filePath, lineNumber);
        }
    }
}
